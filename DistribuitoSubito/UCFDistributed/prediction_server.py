...
class Server:
    ...
    def __init__(self, num_of_predictors, num_of_conv_layers, num_of_pool_layers, num_of_dense_layers, num_of_lstm_layers,
               num_of_gru_layers, num_of_rnn_layers):
    ...
    def socket_listener_nas(self, conn):
        ...
        while True:
            ...
            self.num_of_gru_layers, self.num_of_rnn_layers) = pickle.loads(buffer)
            tmp = (self.num_of_conv_layers, self.num_of_pool_layers, self.num_of_dense_layers, self.num_of_lstm_layers,
...
if __name__ == "__main__":
    ...
    server = Server(config['num_of_predictors'], config['num_of_conv_layers'], config['num_of_pool_layers'], config['num_of_dense_layers'], config['num_of_lstm_layers'], config['num_of_gru_layers'], config['num_of_rnn_layers'])
    unique_class_labels = range(len(config['classes_list']))
